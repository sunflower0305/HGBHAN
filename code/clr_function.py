...
def cyclic_learning_rate(global_step,
    ...
    if global_step is None:
        raise ValueError("cyclic_learning_rate needs global_step")
    ...
    with ops.name_scope(name, "CyclicLearningRate", [learning_rate, global_step]) as name:
        ...
        def cyclic_lr():
            ...
            if mode == 'triangular2':
                clr = math_ops.divide(clr, math_ops.cast(math_ops.pow(2, math_ops.cast(cycle-1, tf.compat.v1.int32)), tf.compat.v1.float32))
